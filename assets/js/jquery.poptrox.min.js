        ...
        e.fn.poptrox_disableSelection = function () {
            ...
            function t() {
                ...
                var o = Math.abs(x.width() - x.outerWidth()), t = Math.abs(x.height() - x.outerHeight()),
                    p = (w.width(), w.height(), i - 2 * r.windowMargin - o), n = s - 2 * r.windowMargin - t;
            ...
            var i, s, r = e.extend({
                    ...
                    onPopupClose: null,
                    onPopupOpen: null
                }, o), n = e(this), a = e("body"), l = e('<div class="' + r.overlayClass + '"></div>'), u = e(window),
                d = [], h = 0, g = !1, f = new Array;
            ...
            var v = x.find(".pic"), w = e(), b = x.find(r.popupLoaderSelector), m = x.find(r.popupCaptionSelector),
                C = x.find(r.popupCloserSelector), y = x.find(r.popupNavNextSelector),
                S = x.find(r.popupNavPreviousSelector), P = y.add(S);
            ...
            return u.on("resize orientationchange", function () {
                ...
                b.trigger("startSpinning").fadeIn(300), x.show(), r.popupIsFixed ? (x.removeClass("loading").width(r.popupWidth).height(r.popupHeight), w.load(function () {
                    ...
                    var e = w.width(), o = w.height(), i = function () {
                ...
                if ("ignore" != n && i.attr("href")) {
                    if (t = {
                        ...
                        if ("function" == typeof r.caption) c = r.caption(i); else if ("selector" in r.caption) {
                            var a;
